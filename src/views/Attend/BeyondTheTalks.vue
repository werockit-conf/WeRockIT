<template>
  <tile bgcolor="bg-white" title="Beyond The Talks" titleColor="text-wri-dark-blue">
    <div class="justify-center flex flex-wrap ">
      <AttendSquareImage image_path="images/attend/mothers_room.png" header="Mothers Room" class="attend_block">
        <p class="text-base">
          A private mothers room equipped with a refrigerator will be available throughout the event
        </p>
      </AttendSquareImage>
      <AttendSquareImage image_path="images/attend/quiet_room.png" header="Quiet Room" class="attend_block">
        <p class="text-base">
          WeRockIT provides a quiet room to work, read, think, or have much needed recovery time.
        </p>
      </AttendSquareImage>
      <AttendSquareImage image_path="images/attend/speed_mentorship.png" header="Speed Mentorship" class="attend_block">
        <p class="text-base">
          Pair off with several experienced professionals to gain insight, advice, and knowledge. Preregistration
          required.
        </p>
      </AttendSquareImage>
      <AttendSquareImage image_path="images/attend/workshops.png" header="Workshops" class="attend_block">
        <p class="text-base">Learn a new skill. WeRockIT will offer beginner to intermediate level workshops</p>
      </AttendSquareImage>
      <AttendSquareImage image_path="images/attend/social_room.png" header="Social Lounge" class="attend_block">
      </AttendSquareImage>
